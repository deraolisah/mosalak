...
const Why = () => {
  return (
    <section className='py-8 md:py-12'>
      <div className='container flex flex-col items-center gap-4 bg-primary/10 p-4 md:p-8 py-10 md:py-16 md:rounded-2xl'>
        ...
        <h2 className='section-title'> Why Choose Mosalak? </h2>   
